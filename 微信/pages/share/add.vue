				...
				uni.chooseImage({
					...
					success: (res) => {
						...
						for (var i = 0; i < tempFiles.length; i++) {
							tempFiles[i].uri = tempFiles[i].path
						}
						console.log(tempFiles1)
						const uploadTask = uni.uploadFile({
							...
							success: (uploadFileRes) => {
								...
								// console.log("uploadFileRes.data",uploadFileRes.data[0]);
								this.imageList = this.imageList.concat(uploadFileRes.data)
								// this.imageList.push(uploadFileRes.data[0])
							}
						});
						// #ifdef APP-PLUS
